...
var $evancz$elm_playground$Playground$lightPurple = $evancz$elm_playground$Playground$Hex('#ad7fa8');
			...
			[
				...
				A2(
					...
					A2(
						...
						computer.mouse.x,
						A2($evancz$elm_playground$Playground$circle, $evancz$elm_playground$Playground$lightPurple, 30))))
			]);
	});
var $author$project$Main$main = A3($evancz$elm_playground$Playground$game, $author$project$Main$view, $author$project$Main$update, _Utils_Tuple0);
